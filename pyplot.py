...
plotpolyfit = plt.plot(x, ppolyfitinf(x), 'r',label='yinf')
plotinf = plt.plot(x, yinf, 'g',label='yinf')
# ploty3 = plt.plot(x, y3, 'b',label='y3')
# ploty25 = plt.plot(x, y25, 'r--',label='y25')
# ploty2 = plt.plot(x, y2, 'g--',label='y2')
# ploty15 = plt.plot(x, y15, 'b--',label='y15')
